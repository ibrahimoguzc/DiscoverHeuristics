...
with open(
        os.path.join("specification_1d_jobscheduling_mdd.txt"),
        encoding="utf-8",
    ) as f:
...
if __name__ == '__main__':
    ...
    global_max_sample_num = None  # if it is set to None, funsearch will execute an endless loop, 10000 was the initial value
    #LOAD SPECIFICATION
    with open(
        os.path.join("specification_1d_jobscheduling_mdd.txt"),
        encoding="utf-8",
    ...
    eq_name = 'm1jobs'
    data_job1m = np.load('data/data_25_10000.npy', allow_pickle=True)
